...
def main():
    ...
    def redraw_window():
        WIN.blit(BG, (0,0))
        param_font_color = (255, 255, 255)
        lives_label = main_font.render(f"Lives : {lives}", 1, param_font_color)
        level_label = main_font.render(f"Level : {level}", 1, param_font_color)
        ...
        if lost:
            ...
            WIN.blit(lost_label,(int(WIDTH/2 - lost_label.get_width()/2), int(HEIGHT/2)))
